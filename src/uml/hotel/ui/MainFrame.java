...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		button.setBounds(68, 10, 48, 48);
		
		Utils.createToolBarItem(button, "pic/ToolBar/m03.gif");
		...
		button_1.setBounds(126, 10, 48, 48);
		
		Utils.createToolBarItem(button_1, "pic/ToolBar/m04.gif");
		panel.add(button_1);
		
		JLabel label_2 = new JLabel("客户结账");
		label_2.setBounds(126, 58, 54, 15);
		panel.add(label_2);
		
		JButton button_2 = new JButton("");
		button_2.setBounds(184, 10, 48, 48);
		
		Utils.createToolBarItem(button_2, "pic/ToolBar/m05.gif");
		...
		label_3.setBounds(184, 58, 54, 15);
		panel.add(label_3);
