 ...
 * 
 * @see uml.hotel.dao.Bill
 * @author MyEclipse Persistence Tools
 */

public class BillDAO extends BaseHibernateDAO {
	...
	public Bill findById(java.lang.Integer id) {
		...
		try {
			Bill instance = (Bill) getSession().get("uml.hotel.model.Bill", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Bill instance) {
		...
		try {
			List results = getSession().createCriteria("uml.hotel.model.Bill")
	...
	public List findByPreferential(Object preferential) {
		return findByProperty(PREFERENTIAL, preferential);
	}

	public List findByPayoff(Object payoff) {
		return findByProperty(PAYOFF, payoff);
	}
